...
const getNextStatus = mole => {
  switch (mole.status) {
    ...
    case "fed":
      ...
      if (mole.king) {
        mole.node.children[0].src = "media/king-mole-leaving.png";
      } else {
        mole.node.children[0].src = "media/mole-leaving.png";
      }
      mole.status = "leaving";
      break;
    case "leaving":
    ...
    case "hungry":
      ...
      if (mole.king) {
        mole.node.children[0].src = "media/king-mole-sad.png";
      } else {
        mole.node.children[0].src = "media/mole-sad.png";
      }
      mole.status = "sad";
      mole.next = getSadInterval();
      break;
    case "gone":
      ...
      if (mole.king) {
        mole.node.children[0].src = "media/king-mole-hungry.png";
      } else {
        mole.node.children[0].src = "media/mole-hungry.png";
      }
      break;
  }
};
...
const feed = e => {
  ...
  mole.node.children[0].classList.toggle("hungry", false);
  if (mole.king) {
    mole.node.children[0].src = "media/king-mole-fed.png";
    score += 20;
  } else {
    mole.node.children[0].src = "media/mole-fed.png";
    score += 10;
  }
